...
- Importing a supported route definition creates start, marshal, unmarshal, set body, set header, set property, set context, convert body, transform, validate, process, delay, and log nodes in order.
